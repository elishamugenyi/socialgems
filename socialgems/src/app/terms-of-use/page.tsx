                ...
                <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg">
                    <section className="px-8 py-12 sm:px-12 sm:py-16">
                        <div className="text-black mb-2">
                            <h1 className="text-2xl sm:text-3xl font-bold text-black">Updated Mobile application Terms of Use - Social Gems 5.3.24</h1>
                        </div>
                        <section className="mb-6">
                            <h2 className="text-2xl font-bold text-black mb-2">PLEASE READ THESE TERMS CAREFULLY</h2>
                        ...
                        <section className="mb-6">
                            <h2 className="text-2xl font-bold text-black mb-2">Who we are and what this agreement does</h2>
                            <p className="mb-4 text-black leading-relaxed">
                                We TEK JUICE LIMITED, a Company registered in England and Wales with 
                                Company Number 14997926, whose registered address is 19 The Office 
                                Village, North Road, Loughborough, Leicestershire, England, LE11 1QJ 
                                (“trading as Social Gems”) license you to use:
                            </p>
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                <li>
                                    Social Gems mobile application software <strong>(App)</strong> 
                                    and any updates or supplements to it.
                                </li>
                                <li>
                                    The service you connect to via the App and the content we 
                                    provide to you through it &nbsp;
                        ...
                        <section className="mb-6">
                            <h2 className="text-2xl font-bold text-black mb-2">Your privacy</h2>
                            <p className="mb-2 text-black">
                                ...
                                exercise them. This information is provided in our 
                                Privacy Notice and it is important that you read that 
                                information.
                            </p>
                        </section>

                        <section className="mb-6">
                            <h2 className="text-2xl font-bold text-black mb-2">Other terms that may apply to you</h2>
                            <p className="mb-2 text-black">The following documents also form part of these terms:</p>
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                <li>
                                    Our Cookie Policy, which sets out information about the cookies used by the App.
                                </li>
                                <li>
                                    Our Influencer or Business Agreements relating to applicable services provided through the App.
                                </li>
                                </ul>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Google Play and the APP Store's terms also apply</h2>
                            <p className="mb-2 text-black">
                                The ways in which you can use the App and Documentation may also be controlled by Google Play or 
                                The App stores' rules and policies and those policies will apply instead of these terms where 
                                there are differences between the two.
                            </p>
                        </section>
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Operating system requirements</h2>
                            <p className="mb-2 text-black">
                                This App requires a [TYPE OF MOBILE PHONE OR HANDHELD DEVICE] 
                                device with a minimum of [AMOUNT OF MEMORY] of memory and the 
                                [TYPE OF OPERATING SYSTEM] operating system 
                                [VERSION OF OPERATING SYSTEM] . [INSERT OTHER REQUIREMENTS].
                            </p>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Support for the App and how to tell us about problems</h2>
                            <p className="mb-2 text-black">
                               <strong> Support.&nbsp;</strong> 
                                If you want to learn more about the App or the Service or have 
                                any problems using them please take a look at our support
                                resources.
                            </p>
                            <p className="mb-2 text-black">
                                <strong> Contacting us (including with complaints).&nbsp;</strong>
                            ...
                            <p className="mb-2 text-black">
                                <strong>How we will communicate with you. &nbsp;</strong>
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">How you may use the App, including how many devices you may use it on</h2>
                            <p className="mb-4 text-black">
                                In return for your agreeing to comply with these terms you may:
                            </p>
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                <li>
                                    download or stream a copy of the App and view, 
                                ...
                                <li>
                                    receive and use any free supplementary software code or 
                                    update of the App incorporating "patches" and corrections 
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">
                                You must be 18 or have parental or guardian consent to accept 
                                these terms and buy the App    
                            </h2>
                            <p className="mb-2 text-black">
                                You must be 18 or over or have parental or guardian consent 
                                to accept these terms and utilise the App.  
                            </p>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">You may not transfer the App to someone else</h2>
                            <p className="mb-2 text-black">
                                We are giving you personally the right to use the App and 
                                the Service as set out above,  you may not otherwise 
                                transfer the App or the Service to someone else, 
                                whether for money, for anything else or for free. 
                                If you sell any device on which the App is installed, 
                                you must remove the App from it.
                            </p>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Changes to these terms</h2>
                            <p className="mb-4 text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Update to the App and changes to the Service</h2>
                            <p className="mb-4 text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">If someone else owns the phone or device you are using</h2>
                            <p className="text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">We are not responsible for other websites you link to</h2>
                            <p className="mb-4 text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Licence restrictions</h2>
                            <p className="mb-4 text-black">
                            ...
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                <li className="text-black mb-2">
                                    ...
                                    available, the App or the Services in any form, in whole 
                                    or in part to any person without prior written consent from us;
                                </li>
                                <li className="text-black mb-2">
                                    not copy the App, Documentation or Services, except as part of 
                                    the normal use of the App or where it is necessary for the 
                                    purpose of back-up or operational security;
                                </li>
                                <li className="text-black mb-2">
                                    not translate, merge, adapt, vary, alter or modify, the whole or 
                                    any part of the App, Documentation or Services nor permit the 
                                    App or the Services or any part of them to be combined with, 
                                    or become incorporated in, any other programs, except as 
                                    necessary to use the App and the Services on devices as 
                                ...
                                <li className="text-black mb-2">
                                    ...
                                    prohibited because they are necessary to decompile the 
                                    App to obtain the information necessary to create an 
                                    independent program that can be operated with the App or 
                                    with another program <strong>(Permitted Objective)</strong>, and provided 
                                ...
                                <li className="text-black mb-2">Comply with all applicable technology control or export laws and regulations that apply to the technology used or supported by the App or any Service.</li>
                            </ul>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Acceptable use restrictions</h2>
                            <p className="mb-4 text-black">
                                You must:
                            </p>
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                ...
                                <li className="text-black mb-2">
                                    ...
                                    <li className="text-black mb-2">not transmit any material that is defamatory, 
                                    offensive or otherwise objectionable in 
                                    relation to your use of the App or any Service;
                                    </li>
                                <li className="text-black mb-2">not use the App or any Service in a way 
                                    that could damage, disable, overburden, 
                                    impair or compromise our systems or security 
                                    or interfere with other users; and 
                                </li>
                                <li className="text-black mb-2">not collect or harvest any information or data from 
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">Intellectual property rights</h2>
                            <p className="text-black">
                        ...
                        <section className="mb-2">
                            ...
                            <p className="mb-4 text-black">
                                <strong>We are not responsible to you for non- foreseeable loss and damage caused by us.  </strong>
                                    Loss or damage is foreseeable if either it is obvious that 
                                    it will happen or if, at the time you accepted these terms, 
                            ...
                            <p className="mb-4 text-black">
                                <strong>When we are liable for damage to your property. </strong> 
                                    We will not be liable for damage that you could have avoided by 
                                    following our advice to apply an update offered to you free of 
                                    charge or for damage that was caused by you failing to 
                                    correctly follow installation instructions or to have 
                                    in place the minimum system requirements advised by us.
                            </p>
                            <p className="mb-4 text-black">
                                <strong>We are not liable for business losses.</strong> 
                                If you use the App for any commercial, business or resale 
                            ...
                            <p className="mb-4 text-black">
                                <strong>Limitations to the App and the Services.</strong> 
                                    The App and the Services are provided for general information 
                                    and entertainment purposes only. They do not offer advice on 
                                    which you should rely. You must obtain professional or 
                                    specialist advice before taking, or refraining from, any 
                                    action on the basis of information obtained from the App 
                                    or the Service. Although we make reasonable efforts to 
                                    update the information provided by the App and the Service, 
                                    we make no representations, warranties or guarantees, 
                                    whether express or implied, that such information is 
                            ...
                            <p className="mb-4 text-black">
                                <strong>Please back-up content and data used with the App.</strong> 
                                    ...
                                    problems with the App or the Service.
                            </p>
                            <p className="mb-4 text-black">
                                <strong>Check that the App and the Services are suitable for you.</strong> 
                                    ...
                                    functions of the App and the Services (as described on the 
                            ...
                            <p className="text-black">
                                <strong>We are not responsible for events outside our control.</strong> 
                                    If our provision of the Services or support for the App or 
                                    the Services is delayed by an event outside our control then 
                                    we will contact you as soon as possible to let you know and we 
                                    will take steps to minimise the effect of the delay. Provided we 
                                    ...
                                    contract with us and receive a refund for any Services you have paid 
                                    for but not received.
                            </p>
                        </section>

                            <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">We may end your rights to use the App and the Services if you break these terms</h2>
                            <p className="mb-4 text-black">
                            ...
                            <ul className="list-disc list-inside space-y-2 mb-2 ml-4 text-black">
                                <li className="text-black mb-2">You must stop all activities authorised by these terms, including your use of the App and any Services.</li>
                                <li className="text-black mb-2">You must delete or remove the App from all devices in your possession and immediately destroy all copies of the App which you have and confirm to us that you have done this.</li>
                                <li className="text-black mb-2">We may remotely access your devices and remove the App from them and cease providing you with access to the Services.</li>
                            </ul>
                        </section>

                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">We may transfer this agreement to someone else</h2>
                            <p className="text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">You need our consent to transfer your rights to someone else</h2>
                            <p className="text-black">
                        ...
                        <section className="mb-2">
                            <h2 className="text-2xl font-bold text-black mb-2">No rights for third parties</h2>
                            <p className="text-black">
